# Generated by Powerlevel10k configuration wizard on 2020-07-21 at 01:22 -03.
...
# blurred tails, 2 lines, disconnected, no frame, compact, concise,
...
() {
  ...
  # Default background color. default = 234
  ...
  # Green prompt symbol if the last command succeeded. default: cyan
