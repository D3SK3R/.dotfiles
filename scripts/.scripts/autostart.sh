...
run dunst
sleep 0.2 && dunstify -i "/usr/share/icons/Papirus-Dark/16x16/emblems/checkmark.svg" "Running autostart script" &
...
sleep 6 && polybar-msg action "#mute.hook.0" >/dev/null &
sleep 6 && polybar-msg action "#target.hook.0" >/dev/null &
#######################
###    programs     ###
#######################
